class MacPowerTools < Formula
  ...
  url "https://github.com/mikejennings/mac-power-tools/archive/refs/tags/v1.1.0.tar.gz"
  sha256 "bfcd82a857027add3e93ace2750f15b33a0739899d8a136ebfb9f8a9f03b7156"
  license "MIT"
  version "1.1.0"
